...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/annabelle.jpg" alt="annabelle">
                <div class="erdikoa">
                    <h1 id="tituloa">ANNABELLE</h1>
                    <h3>Egilea:</h3>
                    <p>Gary Dauberman</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Mckenna Grace, Madison Iseman, Katie Sarife</p>
                    <h3>Laburpena:</h3>
                ...
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 46 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2019ko Uztailaren 3a</p>
                    <h3>Generoa:</h3>
                    <p>Terror, Misterioa, Thriller</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/8kmLHwKH31M?si=qTkJz7UZ33Y6xEYZ"

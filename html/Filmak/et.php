...
$info_filma = 'E.T. El Extraterrestre';
...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/ET.jpg" alt="avatar">
                <div class="erdikoa">
                    <h1 id="tituloa">E.T., El Extraterrestre</h1>
                    <h3>Egilea:</h3>
                    <p>Steven Spielberg</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Henry Thomas, Dee Wallace, Drew Barrymore</p>
                    <h3>Laburpena:</h3>
                    <p>Elliot, bost urteko haur bat, estralurtar baten aurkitu du etxean. Baina haurra ez da
                        estralurtarra normala baino: E.T. da, lurperatuta dagoen lurralde beltza, bere lagunekin batera
                        kaletik kaletik ibiltzen da, baina elkar desagertu ondoren, Elliotek lagun egingo dio, haur eta
                        estralurtarrak elkarren artean lotzen dituzten harremanak desberdinak eginez.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 55 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>1982ko Ekainaren 11a</p>
                    <h3>Generoa:</h3>
                    <p>Zientzia-fikzioa, Aventura, Fantasia</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/p4vSher2e3A?si=a7mZsPy9LuqdqtnI"

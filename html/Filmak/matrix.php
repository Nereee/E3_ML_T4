...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/matrix.jpg" alt="EXORCISTA">
                <div class="erdikoa">
                    <h1 id="tituloa">MATRIX</h1>
                    <h3>Egilea:</h3>
                    <p>Larry Wachowski, Andy Wachowski</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Keanu Reeves, Laurence Fishburne, Carrie-Anne Moss, Hugo Weaving</p>
                    <h3>Laburpena:</h3>
                    <p>Neo izeneko programatzaile gazte bati gertatzen zaio mundu erreala eta mundu birtuala ulertzeko
                        gaitasuna izatea. Irudikatutako errealean, umoreztatutako lurrean, mugimendu hutsa denean, mundu
                        birtuala da, eta programa horren artean irauten duen neurrian. Neo eta bere lagunek, Morpheus
                        eta Trinity, Matrix-en aurrean altxatu beharko dute.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>2 ordu eta 16 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>1999ko Martxoaren 24a</p>
                    <h3>Generoa:</h3>
                    <p>Zientzia-fikzioa, Aventura, Akzioa</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/m8e-FF8MsqU?si=F6jMvBiXOCRtGtfX"

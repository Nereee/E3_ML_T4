...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/dejame_salir.jpg" alt="Alien8">
                <div class="erdikoa">
                    <h1 id="tituloa">DEJAME SALIR</h1>
                    <h3>Egilea:</h3>
                    <p>Jordan Peele</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Daniel Kaluuya, Allison Williams, Catherine Keener, Bradley Whitford</p>
                    <h3>Laburpena:</h3>
                    <p>Chris, nerabe beltza bat, bere sortzeko etxera goititzen da bere neska-erlijio bat ikusteko.
                        Berea baino familia eta hiri osoa, nekaneak, beldurra eta sekretuak ditu. Bere inguruan dagoen
                        misteriotsu komunitate batean sartzean, egia eta errealitatea nahiko ulertzeko nahia izango du.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 44 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2017ko Otsailaren 24a</p>
                    <h3>Generoa:</h3>
                    <p>Terror, Misterioa, Thriller</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/dHj6a5g4ROY?si=5smwBtPuUjIQsLsn"

...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/parasyte.jpg" alt="Alien8">
                <div class="erdikoa">
                    <h1 id="tituloa">Parasite</h1>
                    <h3>Egilea:</h3>
                    <p>Bong Joon-ho, Han Jin-won</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Song Kang-ho, Lee Sun-kyun, Cho Yeo-jeong, Choi Woo-shik</p>
                    <h3>Laburpena:</h3>
                    <p>Ki-taek familiak bizitza apal bat darama eta aukera gutxi izateak eragingo duen saiakera baten
                        bila dago. Batetik, haien bizitzak lotzen dituzten ingurune batean sartuko dira, eta, bestetik,
                        aurpegi bat hartuko dute aurrez aurre ospetsu eta aberats batekin. Baina, noizbait, zulo batean
                        dauden zuloak sartuko dira, eta horrela, estatus soziala aldatuko dute.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>2 ordu eta 12 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2019ko Maisuaren 21a</p>
                    <h3>Generoa:</h3>
                    <p>Drama, Krimen, Thriller</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/90dWVETAdtI?si=7gC06lu3-YeiZ6K5"

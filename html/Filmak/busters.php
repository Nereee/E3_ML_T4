...
<html lang="es">
  ...
  <body>
    ...
    <main>    
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/Ghostbusters.jpg" alt="EXORCISTA">
                <div class="erdikoa">
                    <h1 id="tituloa">CAZAFANTASMAS</h1>
                    <h3>Egilea:</h3>
                    <p>Paul Feig</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Melissa McCarthy, Kristen Wiig, Kate McKinnon, Leslie Jones, Chris Hemsworth</p>
                    <h3>Laburpena:</h3>
                    <p>Cazafantasmas talde berria, New York hiriaren defentsan lan egiten du, hainbat espektru ikuspegi,
                        banshee eta hantxak sortu dituztenak desagertzeko. Taldean sartzen da Kevin, azken contratatu
                        den langilea, baina ikusten den bezala, ez da langile normala izango.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 56 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2016ko Uztailaren 9a</p>
                    <h3>Generoa:</h3>
                    <p>Zientzia-fikzioa, Komedioa, Akzioa</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Mdy0NtpjigQ?si=B9JQ2d2Ti5o3BiFe"

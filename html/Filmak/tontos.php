...
$info_filma = 'Dos Tontos muy Tontos';
...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/Dos_tontos_muy_tontos.jpg" alt="EXORCISTA">
                <div class="erdikoa">
                    <h1 id="tituloa">Dos Tontos muy Tontos</h1>
                    <h3>Egilea:</h3>
                    <p>Peter Farrelly, Bobby Farrelly</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Jim Carrey, Jeff Daniels, Lauren Holly</p>
                    <h3>Laburpena:</h3>
                    <p>Lloyd Christmas eta Harry Dunne, bi lagun tontorrak, Nevada estatuan bizi dira. Harryren duela
                        gutxitutako mini-bus batean ikusten du besteengo emakume batean, eta erabaki egiten du errealeko
                        hartzailea bilakatu. Hartzailea, aske utziko dizkiela uste dute, baina erantzun horrek oso
                        konplikazioak sor ditzake.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 47 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>1994ko Abuztuaren 16a</p>
                    <h3>Generoa:</h3>
                    <p>Komedioa</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/668B7kAf-d8?si=o29SIMKhBEdV-sE-"

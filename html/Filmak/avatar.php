...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/avatar.jpg" alt="avatar">
                <div class="erdikoa">
                    <h1 id="tituloa">AVATAR</h1>
                    <h3>Egilea:</h3>
                    <p>James Cameron</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Sam Worthington, Zoë Saldana, Sigourney Weaver</p>
                    <h3>Laburpena:</h3>
                    <p>Pandora izeneko lurraldean, umee giza espeziea naiko mugatua dago mundu berri batean bizi da. Jake Sully, paraplegikoa den marine batek, bere mendekua hartu du bere hil denean. Pandora esploratzeko proiektu batean sartzen da, eta bere neurri berriek emandako aukera bikaina erabiliz, umeeen artean integratzen da.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>2 ordu eta 42 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2009ko Abuztuaren 18a</p>
                    <h3>Generoa:</h3>
                    <p>Zientzia-fikzioa, Aventura, Akzioa</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/CpXJHWSXJW0?si=3oplT0HGoDjU2MZP"

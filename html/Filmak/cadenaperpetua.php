...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/cadena_perpetua.jpg" alt="cadena_perpetua">
                    <div class="erdikoa">
                        <h1 id="tituloa"> CADENA PERPETUA</h1>
                        <h3>Egilea:</h3>
                            <p>Frank Darabont</p>
                        <h3>Aktore Nagusiak:</h3>
                            <p> Tim Robbins, Morgan Freeman, Bob Gunton <br> 
                            James Whitmore, Gil Bellows</p>
                        <h3>Laburpena:</h3>
                            <p> 
                                Andrew Dufresne (Tim Robbins) emaztearen hilketagatik akusatua, biziarteko kartzela-zigorra jaso ondoren, <br>
                                Shawshankeko kartzelara bidali zuten. Urteak igaro ahala, zentroko zuzendariaren konfiantza eta espetxeko kideen errespetua lortuko ditu, <br>
                                batez ere Sarena (Morgan Freeman), eroskerien mafiako buruarena.
                            </p>
                    </div>
                    <div class="ezkuina">
                        <h3>Iraupena:</h3> 
                        <p> 2 ordu eta 22 minutu</p>
                        <h3>Estreinaldia:</h3>
                        <p> 1995ko otsailaren 24a </p>
                        <h3>Generoa:</h3>
                        <p>Drama</p>
                    </div>
            </div>
            <div id="trailer">
                <iframe width="650" height="405" src="https://www.youtube.com/embed/awZGlOG0GZE?si=ILjmzTa7B0dO49By" title="YouTube video player"

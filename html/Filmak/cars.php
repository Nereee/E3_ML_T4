...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/cars.jpg" alt="Cars 1">
                <div class="erdikoa">
                    <h1 id="tituloa">Cars</h1>
                    <h3>Egilea:</h3>
                    <p>John Lasseter, Joe Ranft, Jorgen Klubien</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Owen Wilson, Bonnie Hunt, Paul Newman, Larry the Cable Guy, <br>
                        Cheech Marin, Tony Shalhoub
                    </p>
                    <h3>Laburpena:</h3>
                    <p>Radiatoreko herria eraldatu egiten da, autoshow handi batean parte hartzeko aukera izan duen Lightining McQueen auto txakur batek negar egin duenean.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 57 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2006ko Ekainaren 9a</p>
                    <h3>Generoa:</h3>
                    <p>Animazioa, Aventura, Komedia</p>
                </div>
            </div>
            
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/W_H7_tDHFE8?si=bagaA9j2e6HB-CIp"

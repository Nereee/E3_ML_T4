...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/el_gran_lebowski.jpg" alt="lebowski">
                <div class="erdikoa">
                    <h1 id="tituloa">EL GRAN LEBOWSKI</h1>
                    <h3>Egilea:</h3>
                        <p>Ethan Jesse Coen eta Joel David Coen</p>
                    <h3>Aktore Nagusiak:</h3>
                        <p>
                            Jeff Bridges, John Goodman, Julianne Moore, Steve Buscemi, David Huddleston, <br> 
                            Ben Gazzara, Philip Seymour Hoffman, Tara Reid
                        </p>
                    <h3>Laburpena:</h3>
                        <p> "El Nota" (Jeff Bridges), Los Angelesen bizi den lauso bat, egun batean Jeff Lebowski aberatsarekin
                            matoi pare batekin topatzen da. Matoiak bere alfonbran pixa egin ondoren, El Nota "El Gran Lebowski"
                            bilatzen hasten da.
                        </p>
                </div>
                <div class="ezkuina">
                    ...
                    <h3>Estreinaldia:</h3>
                    <p>1998ko apirilaren 24a</p>
                    <h3>Generoa:</h3>
                    <p>Komedia</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/tE4--lpy3Pg?si=ZE_o--0gxl-fXWGI" 

...
$info_filma = 'Aterriza como puedas';
...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/aterrizapuedas.png" alt="aterriza">
                <div class="erdikoa">
                    <h1 id="tituloa">ATERRIZA COMO PUEDAS</h1>
                    <h3>Egilea:</h3>
                        <p>Jim Abrahams, Jerry Zucker eta David Zucker</p>
                    <h3>Aktore Nagusiak:</h3>
                        <p>Robert Hays, Leslie Nielsen, Julie Hagerty, Kareem Abdul-Jabbar, <br>
                            Peter Graves.
                        </p>
                    <h3>Laburpena:</h3>
                        <p> Trans American 209 hegaldia Los Angelesetik Chicagora doa. Pasartean pertsonaia bitxi batzuk daude. <br>
                            Horien artean, ex-militar pilotu bat, hegazkin komertzialaren agintea hartu beharko duena, 
                            pilotuak ondoezik geratu ondoren.
                        </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3> 
                    <p> Ordu bat eta 28 minutu </p>
                    <h3>Estreinaldia:</h3>
                    <p> 1980ko Abenduaren 18a</p>
                    <h3>Generoa:</h3>
                    <p>Komedia</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/epNuhFkPy3s?si=YL1lF2Xa_6DoTyME" title="YouTube video player"

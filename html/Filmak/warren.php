...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/espediente_warren_1.jpg" alt="warren">
                <div class="erdikoa">
                    <h1 id="tituloa">EXPEDIENTE WARREN</h1>
                    <h3>Egilea:</h3>
                    <p>James Wan, Chad Hayes, Carey W. Hayes</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Patrick Wilson, Vera Farmiga, Lili Taylor, Ron Livingston</p>
                    <h3>Laburpena:</h3>
                    <p>Ed eta Lorraine Warren matematika bidezko enigma bat aztertzeko prest dauden paranormalen adituak
                        dira. Hainbat kasutan parte hartu dute, bai misterio iraultzaileak eta bai arriskutsuagoak.
                        Historia honek, familia bat aurpegiratu du, etxeko esentzia nahiagoa eta etxe hori hartu nahiko
                        lukeen esentzia okultoarekin loturik.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 52 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2013ko Ekainaren 8a</p>
                    <h3>Generoa:</h3>
                    <p>Terror, Misterioa, Thriller</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/1kOlrEwTfco?si=JlCIu8AzavNbvvff"

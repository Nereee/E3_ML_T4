...
<html lang="es">
  ...
  <body>
    ...
    <main>
        <section>
            <div class="infofilma">
                <img src="../irudiak/filmaPortadak/Resacon_en_las_vegas.jpg" alt="EXORCISTA">
                <div class="erdikoa">
                    <h1 id="tituloa">Resacón en Las Vegas</h1>
                    <h3>Egilea:</h3>
                    <p>Jon Lucas, Scott Moore</p>
                    <h3>Aktore Nagusiak:</h3>
                    <p>Bradley Cooper, Ed Helms, Zach Galifianakis, Justin Bartha</p>
                    <h3>Laburpena:</h3>
                    <p>Lau lagunek Las Vegasera bidai bat egin dute, batez ere batengandik ezkontza afarian dagoenean.
                        Hala ere, errege baten antzerako festa bat amaitu ondoren, erresakadun batez aurkitzen dira, eta
                        gau bat galtzen dute. Gau hartan gertatu zirena gogoratzen saiatzen direnean, gertaerakilarik
                        zabaleko eta barregarriak gertatzen dira.
                    </p>
                </div>
                <div class="ezkuina">
                    <h3>Iraupena:</h3>
                    <p>1 ordu eta 40 minutu</p>
                    <h3>Estreinaldia:</h3>
                    <p>2009ko Ekainaren 5a</p>
                    <h3>Generoa:</h3>
                    <p>Komedioa</p>
                </div>
            </div>
            <div id="trailer">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/MckEHmSMg-0?si=O6oSgJDd6PwZI5St"
